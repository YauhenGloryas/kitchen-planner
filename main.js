...
import { 
    ...
    createDetailedLowerSwingGeometry,
    createDetailedDrawerCabinetGeometry,
    createDetailedOvenCabinetGeometry,
    createDetailedDishwasherGeometry,
    createDetailedFalsePanelGeometry,
    createDetailedFridgeCabinetGeometry
...
function getDetailedCabinetRepresentation(cabinetData) {
    ...
    if (cabinetData.cabinetConfig === 'falsePanel') {
        ...
        return createDetailedFalsePanelGeometry(cabinetData, kitchenGlobalParams, MaterialManager, getPanelThickness);
    } else if (
        ...
        (cabinetData.cabinetConfig === 'swing') // Явно проверяем конфиги для createDetailedCabinetGeometry
    ) {
        //console.log(`[Dispatcher] -> Вызов createDetailedLowerSwingGeometry для '${cabinetData.cabinetConfig}'`);
        return createDetailedLowerSwingGeometry(cabinetData, kitchenGlobalParams, MaterialManager, getPanelThickness);
    } else if (
        (cabinetData.type === 'lowerCabinet' || cabinetData.type === 'freestandingCabinet') && // Для нижних и отдельно стоящих
        cabinetData.cabinetType === 'straight' &&
        (cabinetData.cabinetConfig === 'drawers') // Явно проверяем конфиги для createDetailedCabinetGeometry
    ) {
        console.log(`[Dispatcher] -> Вызов createDetailedCabinetGeometry для '${cabinetData.cabinetConfig}'`);
        return createDetailedDrawerCabinetGeometry(cabinetData, kitchenGlobalParams, MaterialManager, getPanelThickness);
        ...
        return createDetailedOvenCabinetGeometry(cabinetData, kitchenGlobalParams, MaterialManager, getPanelThickness); // <--- ВЫЗОВ НОВОЙ ФУНКЦИИ
    } else if (
        ...
        return createDetailedFridgeCabinetGeometry(cabinetData, kitchenGlobalParams, MaterialManager, getPanelThickness); // <--- ВЫЗОВ НОВОЙ ФУНКЦИИ
    } else if ( // <--- НОВЫЙ БЛОК ДЛЯ FRIDGE ---
        (cabinetData.type === 'lowerCabinet') &&
        cabinetData.cabinetType === 'straight' &&
        cabinetData.cabinetConfig === 'dishwasher'
    ) {
        console.log(`[Dispatcher] -> Вызов createDetailedDishwasherGeometry для '${cabinetData.cabinetConfig}'`);
        return createDetailedDishwasherGeometry(cabinetData, kitchenGlobalParams, MaterialManager, getPanelThickness); // <--- ВЫЗОВ НОВОЙ ФУНКЦИИ
    } else if (
